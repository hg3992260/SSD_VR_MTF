...
DEVICE_NI float GetIntensity(const int& VolumeID, const Vec3f& P)
{
	return gpVolumes[VolumeID](P);
}

DEVICE_NI Vec3f GradientCD(const int& VolumeID, const Vec3f& P)
{
...
DEVICE_NI Vec3f GradientFD(const int& VolumeID, const Vec3f& P)
{
...
DEVICE_NI Vec3f GradientFiltered(const int& VolumeID, const Vec3f& P)
{
...
DEVICE_NI Vec3f Gradient(const int& VolumeID, const Vec3f& P)
{
...
DEVICE_NI Vec3f NormalizedGradient(const int& VolumeID, const Vec3f& P)
{
	return Normalize(Gradient(VolumeID, P));
}

DEVICE_NI float GradientMagnitude(const int& VolumeID, const Vec3f& P)
{
	Vec3f Pts[3][2];
