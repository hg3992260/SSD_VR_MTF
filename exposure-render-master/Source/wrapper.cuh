...
template<class T> static inline void MemCopyHostToDeviceSymbol(T* pHost, const void* pDeviceSymbol, const int& Num = 1, const int& Offset = 0)
{
	Cuda::ThreadSynchronize();
...
template<class T> static inline void MemCopyDeviceToDeviceSymbol(T* pDevice, const void* pDeviceSymbol, const int& Num = 1, const int& Offset = 0)
{
	Cuda::ThreadSynchronize();
